// Merge Sort implementation obtained from https://malithjayaweera.com/2019/02/parallel-merge-sort/
...
int main(int argc, const char * argv[]) {
    printf("Execution time for %d threads:\n", NUM_THREADS);
